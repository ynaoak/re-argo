...
mod tests {
    ...
    fn elf64_roundtrips_through_loader() {
        ...
        let info = gr_loader::BinaryLoader::load_bytes(&elf).expect("carved ELF must load");
    ...
    fn elf32_be_header_is_wellformed() {
        ...
        let info = gr_loader::BinaryLoader::load_bytes(&elf).expect("carved ELF32 must load");
