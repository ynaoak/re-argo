...
impl SleighInstruction {
    ...
    pub fn is_branch(&self) -> bool {
        self.pcode.iter().any(|op| matches!(
            op.opcode,
            gr_core::pcode::OpCode::Branch | gr_core::pcode::OpCode::CBranch
    ...
    pub fn is_call(&self) -> bool {
        self.pcode.iter().any(|op| matches!(
            op.opcode,
            gr_core::pcode::OpCode::Call | gr_core::pcode::OpCode::CallInd
        ))
    }

    pub fn is_return(&self) -> bool {
        self.pcode.iter().any(|op| op.opcode == gr_core::pcode::OpCode::Return)
    }
}
